<x-dashboard.layout :title="__('label.podcasters')">
            ...
            <div class="col-12">
                ...
                <div class="card">
                    <div class="card-header">
                        <h4>{{ __('label.filter_podcasters') }}</h4>
                    </div>
                    <div class="card-body">
                        <div class="row">
                ...
                <div class="card">
                    <div class="card-header border-bottom">
                        <h4 class="card-title">{{ __('label.podcasters') }}</h4>
                        <div class="btns-top gap-1">
                            ...
                            @permission('podcasters-update')
                                <x-dashboard.notify-all type="podcaster">
                            ...
                            @endpermission
                            @permission('podcasters-create')
                                <a href="{{ route('admin.podcasters.create') }}" class="btn btn-primary">
                    ...
                    <div class="card-body">
                        <div class="card-datatable">
                            <form id="bulk_delete_form" action="{{ route('admin.podcasters.bulkDelete') }}"
                                method="POST">
                                @csrf
                                @method('DELETE')
    ...
    @push('js')
        ...
        <script>
            $(document).ready(function() {
                const table = loadServerDataTable('.datatables-ajax', "{{ route('admin.podcasters.index') }}", [{
                        data: 'checkbox',
                        name: 'checkbox',
