<x-dashboard.layout :title="__('label.edit_admin')">
    ...
    <section id="multiple-column-form">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">{{ __('label.edit_admin') }}</h4>
            </div>
                            ...
                            <div class="mb-1">
                                ...
                                <select id="role" name="role" class="select2 form-select">
                                    ...
                                    @foreach ($roles as $role)
                                        <option value="{{ $role->id }}" @selected(old('role', $admin->roles->first()->id) == $role->id)>
                                            {{ $role->name }}
                                        </option>
                                    @endforeach
                                </select>
