<x-dashboard.layout :title="__('label.categories')">
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header border-bottom">
                        <h4 class="card-title">{{ __('label.categories') }}</h4>
                    ...
                    <div class="card-body">
                        <div class="card-datatable">
                            <form id="bulk_delete_form" action="{{ route('admin.categories.bulkDelete') }}"
                                method="POST">
                                @csrf
                                @method('DELETE')
    ...
    @push('js')
        ...
        <script>
            $(document).ready(function() {
                loadServerDataTable('.datatables-ajax', "{{ route('admin.categories.index') }}", [{
                        data: 'checkbox',
                        name: 'checkbox',
