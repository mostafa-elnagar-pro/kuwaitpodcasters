<x-dashboard.layout :title="__('label.edit_category')">
    ...
    <section id="multiple-column-form">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">{{ __('label.edit_category') }}</h4>
            </div>
                    ...
                    <div class="tab-content" id="nav-tabContent">
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="mb-2">
                                            <label class="form-label" for="Name">
                                                {{ __("label.name_$lang->abbr") }}
                                            </label>
                                            <input type="text" id="name" name="name[{{ $lang->abbr }}]"
                                                value="{{ old("name.$lang->abbr", $category->getTranslation('name', $lang->abbr)) }}"
                        ...
                        <div class="row">
                            <div class="col-md-6 col-12 d-flex align-items-center parent">
                                ...
                                <img src="{{ displayFile($category->image) }}" id="preview_img"
