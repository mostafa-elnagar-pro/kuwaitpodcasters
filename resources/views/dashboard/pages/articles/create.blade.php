<x-dashboard.layout :title="__('label.new_article')">
    @section('breadcrumb')
    ...
    <section id="multiple-column-form">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">{{ __('label.new_article') }}</h4>
            </div>
                                ...
                                <div class="tab-pane fade {{ $loop->first ? 'active' : '' }} show"
                                    ...
                                    <div class="row">
                                        <div class="mb-2">
                                            ...
                                            <input type="text" id="title" name="title[{{ $lang->abbr }}]"
                                                value="{{ old("title.$lang->abbr") }}" class="form-control"
                                    ...
                                    <div class="row">
                                        <div class="mb-2">
                                            ...
                                            <textarea rows="2" id="short_body" name="short_body[{{ $lang->abbr }}]" class="form-control"
                                                placeholder="{{ __('label.short_body') }}">{{ old("short_body.$lang->abbr") }}</textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="mb-2">
                                            ...
                                            <x-dashboard.ckeditor5 :$lang name="body" />
                                        </div>
                                    </div>
