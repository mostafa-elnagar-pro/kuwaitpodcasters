<x-dashboard.layout :title="__('label.books')">
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header border-bottom">
                        <h4 class="card-title">{{ __('label.books') }}</h4>
                    ...
                    <div class="card-body">
                        <div class="card-datatable">
                            <form id="bulk_delete_form" action="{{ route('admin.books.bulkDelete') }}"
                                method="POST">
                                @csrf
                                @method('DELETE')
    ...
    @push('js')
        ...
        <script>
            $(document).ready(function() {
                loadServerDataTable('.datatables-ajax', "{{ route('admin.books.index') }}", [{
                        data: 'checkbox',
                        name: 'checkbox',
