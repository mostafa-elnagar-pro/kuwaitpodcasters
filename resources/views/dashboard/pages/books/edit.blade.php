<x-dashboard.layout :title="__('label.edit_book')">
    ...
    <section id="multiple-column-form">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">{{ __('label.edit_book') }}</h4>
            </div>
                                ...
                                <div class="row">
                                    <div class="mb-2">
                                        ...
                                        <input type="text" id="name" name="name[{{ $lang->abbr }}]"
                                            value="{{ old("name.$lang->abbr", $book->getTranslation('name', $lang->abbr) ?? '') }}"
                                            class="form-control" placeholder="{{ __('label.book_name') }}" />
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="mb-2">
                                        ...
                                        <input type="text" id="author" name="author[{{ $lang->abbr }}]"
                                            value="{{ old("author.$lang->abbr", $book->getTranslation('author', $lang->abbr) ?? '') }}"
                                            class="form-control" placeholder="{{ __('label.author') }}" />
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="mb-2">
                                        ...
                                        <textarea rows="4" id="summary" name="summary[{{ $lang->abbr }}]" class="form-control"
                                            placeholder="{{ __('label.summary') }}">{{ old("summary.$lang->abbr", $book->getTranslation('summary', $lang->abbr) ?? '') }}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="mb-2">
                                        ...
                                        <input type="text" id="publisher" name="publisher[{{ $lang->abbr }}]"
                                            value="{{ old("publisher.$lang->abbr", $book->getTranslation('publisher', $lang->abbr) ?? '') }}"
                                            class="form-control" placeholder="{{ __('label.publisher') }}" />
                                    </div>
                                </div>
                    ...
                    <div class="row">
                        <div class="mb-2">
                            ...
                            <input type="number" id="publication_year" name="publication_year"
                                value="{{ old('publication_year', $book->publication_year) }}" class="form-control"
