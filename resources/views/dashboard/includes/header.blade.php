        ...
        <ul class="nav navbar-nav align-items-center ms-auto">
                ...
                <div class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdown-flag">
                    ...
                    @else
                        <a class="dropdown-item" href="{{ LaravelLocalization::getLocalizedURL('ar') }}"
                            data-language="ar">
                            <i class="flag-icon flag-icon-sa">
                            </i> {{ __('locale.ar') }}</a>
                    @endif
                </div>
            </li> --}}
            ...
            <li class="nav-item dropdown dropdown-user"><a class="nav-link dropdown-toggle dropdown-user-link"
                ...
                <div class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdown-user">
                    ...
                    <a class="dropdown-item" onclick="event.preventDefault(); $('#admin_logout').submit()"
                        href="#"><i class="me-50" data-feather="power"></i> {{ __('action.logout') }}</a>
                    <form action="{{ route('admin.logout') }}" id="admin_logout" method="post">
                        @csrf
                    </form>
                </div>
            </li>
